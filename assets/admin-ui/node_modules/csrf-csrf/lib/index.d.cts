...
declare module "express-serve-static-core" {
    interface Request {
        csrfToken?: (overwrite?: boolean, validateOnReuse?: boolean) => ReturnType<CsrfTokenCreator>;
    }
}
...
declare function doubleCsrf({ getSecret, getSessionIdentifier, cookieName, cookieOptions: { sameSite, path, secure, httpOnly, ...remainingCookieOptions }, delimiter, size, ignoredMethods, getTokenFromRequest, errorConfig: { statusCode, message, code, }, skipCsrfProtection, }: DoubleCsrfConfigOptions): DoubleCsrfUtilities;
