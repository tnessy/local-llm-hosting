# 08 — Web UI: Open WebUI

← [07 LiteLLM](07-gateway-litellm.md) · Next: [09 Tailscale](09-connectivity-tailscale.md)
...
>
> **Why:** The first account created becomes admin. Open signup must be disabled before step 10 exposes the URL publicly — one wrong setting here allows anonymous account creation by anyone with the link.
>
> **Placeholders to gather before starting:**
>
> | Placeholder | What it is | Where to find it |
> |---|---|---|
> | `OPENWEBUI_LITELLM_KEY` | LiteLLM virtual key for Open WebUI's backend connection | Minted and patched into the `openwebui-credentials` Secret in [step 07 §2](07-gateway-litellm.md) |
...
- models exist (after [step 06](06-models.md)).
